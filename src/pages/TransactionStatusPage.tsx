                ...
                <CardContent className="flex flex-col w-full h-full gap-6">
                    ...
                    <div className="flex flex-col justify-between p-3 rounded-lg gap-5 bg-gray-50">
                        ...
                        <CardDescription className="flex items-center justify-between">
                            <Link to={`/recipe/details/${recipe.id}`} className="bg-emerald-600 text-white text-center transition duration-300 ease-in-out hover:bg-emerald-900 hover:text-white p-2 rounded-md text-blue-500 font-bold cursor-pointer">
                                See Recipe
                            </Link>
